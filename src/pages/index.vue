<script setup lang="ts">
	import { VvForm, VvFormField, VvFormWrapper } from "~/forms/UserForm"
	...
	<div class="flex flex-col flex-1 min-w-full bg-surface-2">
		<div class="grid grid-cols-3 flex-1">
			<div
				...
				<div class="rounded-md form-shadow px-10 w-3/4">
					<VvForm v-model="formData" class="p-md" @submit="onSubmit">
						<div class="grid grid-cols-2 gap-md mb-10 items-start">
			...
			<div
				class="
					p-md
					border-l border-solid border-alpha-1
					flex flex-col
					justify-center
				">
				<div
